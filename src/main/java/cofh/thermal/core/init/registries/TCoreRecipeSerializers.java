...
public class TCoreRecipeSerializers {
    ...
    public static final RegistryObject<MachineRecipeSerializer<CrystallizerRecipe>> CRYSTALLIZER_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register(ID_CRYSTALLIZER_RECIPE, () -> new MachineRecipeSerializer<>(CrystallizerRecipe::new, CrystallizerRecipeManager.instance().getDefaultEnergy()));
